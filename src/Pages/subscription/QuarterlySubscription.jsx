...
const QuarterlySubscription = () => {
  ...
  return (
    <div>
      <h3 className="text-3xl font-semibold mt-10">Quarterly Plan</h3>
      <p className="text-2xl font-bold text-blue-900">
        ${newPrice} <span className="text-gray-500 text-sm">/Quarter</span>
      </p>
...
export default QuarterlySubscription
